...
export default function Friends({ userId, userData }: FriendsProps) {
  ...
  const botUsername = 'hfgsqhve_bot'; // نام ربات خود را اینجا بگذارید
  ...
  const earnedFromReferrals = referralsCount * 1000;
    ...
    <div className="flex flex-col h-full w-full p-6 space-y-5 items-center">
      ...
      >
        ...
        <p className="text-white/50 text-sm max-w-xs leading-relaxed">
          ...
          <span className="text-yellow-400 font-bold">۱۰۰۰ سکه</span>{' '}
          پاداش می‌گیرید.
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-sm flex flex-col gap-4">
        ...
        >
          ...
          {[
            ...
            { step: '۳', text: 'وقتی دوستتان وارد شد، ۱۰۰۰ سکه می‌گیرید' },
          ].map(item => (
